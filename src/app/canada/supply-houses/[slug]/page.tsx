...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://heatpumplocator.com/canada/supply-houses/${house.slug}`,
    },
  };
}
...
export default async function SupplyHousePage({
  ...
  const breadcrumbItems = [
    ...
    { name: 'Supply Houses', url: 'https://heatpumplocator.com/supply-houses' },
    {
      ...
      url: `https://heatpumplocator.com/canada/supply-houses/${house.slug}`,
    },
  ];
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <Link href="/canada/supply-houses" className="hover:text-primary-600">Supply Houses</Link>
          <span className="mx-2">/</span>
        ...
        <div className="bg-blue-50 border-l-4 border-primary-500 p-5 mb-8">
          <p className="text-sm text-gray-700">
            ...
            <Link href="/canada/directory" className="text-primary-600 hover:text-primary-700 font-medium">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-wrap gap-4">
          <Link href="/canada/supply-houses" className="text-primary-600 hover:text-primary-700 font-medium">
            ← All supply houses
          </Link>
          <Link href="/canada/brands" className="text-primary-600 hover:text-primary-700 font-medium">
