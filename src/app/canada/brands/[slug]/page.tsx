...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://heatpumplocator.com/canada/brands/${brand.slug}`,
    },
  };
}
...
export default async function BrandPage({
  ...
  const breadcrumbItems = [
    ...
    { name: brand.name, url: `https://heatpumplocator.com/canada/brands/${brand.slug}` },
  ];
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <Link href="/canada/brands" className="hover:text-primary-600">Brands</Link>
          <span className="mx-2">/</span>
        ...
        {multiBrandDealers.length > 0 && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-10">
            ...
            <Link href="/canada/directory" className="text-sm text-primary-600 hover:text-primary-700 font-medium">
        ...
        {brand.coldClimateRated && (
          <div className="bg-white border border-gray-200 rounded-lg p-5 mb-8">
            ...
            <p className="text-sm text-gray-700">
              ...
              <Link href="/canada/brands" className="text-primary-600 hover:text-primary-700">
