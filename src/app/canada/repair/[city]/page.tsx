...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://heatpumplocator.com/canada/repair/${city.slug}`,
    },
  };
}
...
export default async function CityRepairPage({
  ...
  const breadcrumbItems = [
    ...
    { name: city.name, url: `https://heatpumplocator.com/canada/repair/${city.slug}` },
  ];
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <Link href="/canada/repair" className="hover:text-primary-600">Heat Pump Repair</Link>
          <span className="mx-2">/</span>
          <span>{city.name}</span>
        </nav>
        ...
        <div className="mb-12">
          ...
          {listings.length > 0 && (
            <div className="mt-5 text-center">
              <Link href="/canada/directory" className="text-primary-600 hover:text-primary-700 font-medium text-sm">
