...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://heatpumplocator.com/canada/guides/${slug}` },
  };
}
...
export default async function GuidePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbItems = [
    ...
    { name: slug, url: `https://heatpumplocator.com/canada/guides/${slug}` },
  ];
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <Link href="/canada/guides" className="hover:text-primary-600">Guides</Link>
          <span className="mx-2">/</span>
        ...
        <div className="mt-12 bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link href="/canada/brands" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2">
            ...
            <Link href="/canada/service" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2">
              <span>→</span> Service & Repair Guide
            </Link>
            <Link href="/canada/faq" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2">
              <span>→</span> FAQ
            </Link>
          </div>
        </div>
