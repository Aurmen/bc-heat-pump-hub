...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://heatpumplocator.com/canada/guides/interior-bc',
  },
  keywords: [
...
export default function InteriorBCResourceCenter() {
  const breadcrumbItems = [
    ...
    { name: 'Interior BC', url: 'https://heatpumplocator.com/canada/guides/interior-bc' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <Link
                  href="/canada/guides/fujitsu-vs-mitsubishi-cold-climate"
                ...
                <Link
                  href="/canada/guides/oil-furnace-heat-pump-conversion-bc"
                  className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center gap-1.5"
                >
                  <span aria-hidden="true">→</span>
