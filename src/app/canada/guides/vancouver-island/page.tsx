...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://heatpumplocator.com/canada/guides/vancouver-island',
  },
  keywords: [
...
export default function VancouverIslandResourceCenter() {
  const breadcrumbItems = [
    ...
    { name: 'Vancouver Island', url: 'https://heatpumplocator.com/canada/guides/vancouver-island' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <Link
                  href="/canada/guides/ductless-vs-central-heat-pumps-bc"
