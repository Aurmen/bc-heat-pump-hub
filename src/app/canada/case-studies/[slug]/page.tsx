...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://heatpumplocator.com/canada/case-studies/${slug}`,
    },
  };
}
...
export default async function CaseStudyPage({
  ...
  const breadcrumbItems = [
    ...
    { name: meta.title, url: `https://heatpumplocator.com/canada/case-studies/${slug}` },
  ];
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <Link href="/canada/case-studies" className="hover:text-primary-600">Case Studies</Link>
          <span className="mx-2">/</span>
        ...
        <div className="mt-12 bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Link href="/canada/guides/heat-pump-sizing-guide-bc" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
              <span>→</span> Heat Pump Sizing Guide for BC
            </Link>
            <Link href="/canada/guides/best-cold-climate-heat-pump-bc-2026" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
              <span>→</span> Cold Climate Heat Pump Selection
            </Link>
            <Link href="/canada/guides/heat-pump-home-assessment-checklist-bc" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
              <span>→</span> Pre-Install Assessment Checklist
            </Link>
            <Link href="/canada/repair/kelowna" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
              <span>→</span> Kelowna Heat Pump Repair Guide
            </Link>
            <Link href="/canada/repair/vernon" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
              <span>→</span> Vernon Heat Pump Repair Guide
            </Link>
            <Link href="/canada/directory" className="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2 text-sm">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
          <Link href="/canada/case-studies" className="text-primary-600 hover:text-primary-700 font-medium text-sm">
            ← All Case Studies
          </Link>
