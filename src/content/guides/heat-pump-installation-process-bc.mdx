...
**Canada Greener Homes Grant:** ~~Pre-retrofit EnerGuide evaluation required~~ **(Grant discontinued 2024)**
- The Grant program ended in 2024, but an EnerGuide evaluation may still be required for the **Canada Greener Homes Loan** (up to $40,000 at 0% interest)
...
**Canada Greener Homes Loan** (Grant discontinued 2024)**:**
- If applying for the Loan, a post-retrofit EnerGuide evaluation may be required
- Submit invoices and evaluation report as directed by the Loan program
- Check current requirements at the NRCan website
