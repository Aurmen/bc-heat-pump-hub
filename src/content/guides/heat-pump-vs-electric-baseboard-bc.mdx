...
Baseboard owners in the Lower Mainland are leaving the most money on the table. The case for switching is strong in most coastal BC scenarios.
...
- **Paid back in 3-7 years** — then generating estimated net savings for the remainder of its lifespan
...
For the majority of BC baseboard-heated homeowners, this is one of the strongest financial decisions in home energy for many BC homeowners.
